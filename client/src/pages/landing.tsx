        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            <Button 
              size="lg" 
              onClick={handleLogin} 
              className="bg-foreground text-background hover:opacity-90 text-lg px-10 py-7 shadow-xl hover:shadow-2xl transition-all"
            >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col items-center gap-6 mb-8">
            <Button 
              size="lg" 
              onClick={handleLogin} 
              className="text-xl px-12 py-8 shadow-2xl hover:shadow-3xl transition-all transform hover:scale-105"
              style={{ backgroundColor: 'hsl(259 100% 65%)', color: 'white' }}
            >
